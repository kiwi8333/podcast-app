import { Play, Pause, RotateCcw, RotateCw, Radio } from "lucide-react";
...
export default function AudioPlayer() {
  ...
  // A live stream has no duration, no position to scrub to and nothing that
  // playing it faster would mean. Rather than show those controls disabled,
  // the bar drops them and says what it is instead.
  const isLive = Boolean(nowPlaying.isLive);
